...
public class TopLevelSettings extends DashboardFragment implements SplitLayoutListener,
    ...
    private void initCustomizationAdditions(){
        final boolean customizationSummary = Settings.System.getIntForUser(getContext().getContentResolver(),
                Settings.System.CUSTOMIZATION_SUMMARY, 0, UserHandle.USER_CURRENT) != 0;
        Preference customizationPref = getPreferenceScreen().findPreference("top_level_customization");

        if (!customizationSummary){
            customizationPref.setSummary(null);
        } else {
            customizationPref.setSummary(R.string.customization_summary);
        }
    }
    ...
    private void initPreferenceCard(){
        ...
        for (int i = 0; i < getPreferenceScreen().getPreferenceCount(); i++) {
            ...
            if (pref.isVisible() && pref.getTitle() != null && 
                ...
                pref.getLayoutResource() != R.layout.fortune_dashboard_pref_customization ) {
    ...
    protected List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        return buildPreferenceControllers(context, getSettingsLifecycle(), mMetricsFeatureProvider,
                this /* fragment */,  this /* LifecycleOwner */);
    }
